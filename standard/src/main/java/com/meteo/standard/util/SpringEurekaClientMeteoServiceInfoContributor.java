...
public class SpringEurekaClientMeteoServiceInfoContributor implements InfoContributor {
    ...
    public void contribute(Info.Builder builder) {
        builder.withDetail("details",
                Collections.singletonMap("description", "This is the meteo service, which is discovery server aware, and this service will Call Student Microservice, fro student details, which is again dicovery server aware!!! "));
    }
